    ...
    <div>
      ...
      <div className="seconds-allowed-container">
        ...
        <StartingTimeBox
          ...
          handleSubmitTime={handleEditStartingTime}
          changesForbidden={isGameRunning || gameStopped}
        />
      </div>
      ...
      <div className="start-reset-container">
        <button className="button--start" onClick={startGame} disabled={isGameRunning}>
          Start
        </button>
        <button className="button--reset" onClick={handleReset} aria-label="stop running game or reset timer">
